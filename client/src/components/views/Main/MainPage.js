    ...
    <div id="body" style={{ width: "100vw" }}>
      <Helmet>
        ...
        <meta
          ...
          content="7n5xoSLEUqYqdIAzcqRHF0y5c4Q-A-FFJC4_BsDC9TQ"
        />
      </Helmet>
      <div className="main-info">
        <h2>
          광활한 콘텐츠의 우주에 오신 것을 환영합니다.
          <br />
          저는 당신의 콘텐츠 여행을 돕는 가이드, BRINGCON입니다.
        </h2>
        <SearchFeature
          refreshFunction={submitSearchTerm}
          style={{ width: "500px" }}
        />
      </div>
      ...
      {Entered === 1 && (
        <Redirect
          to={{ pathname: "/contents", search: `?q=${newSearchTerm}` }}
        />
      )}
    </div>
  );
